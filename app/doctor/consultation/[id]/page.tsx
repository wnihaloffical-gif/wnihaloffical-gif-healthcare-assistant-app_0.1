...
export default function DoctorConsultationPage() {
  ...
  useEffect(() => {
    ...
    const mockConsultation: Consultation = {
      ...
      patientId: "user-1",
      doctorId: "user-2",
      transcription: "I have had fever, cough, and body aches for the past 3 days. No other symptoms.",
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <h1 className="text-2xl font-bold text-primary">Review Consultation</h1>
        </div>
      </header>

      <main className="max-w-6xl mx-auto px-4 py-8">
        <DoctorConsultationReview consultation={consultation} language={language} />
      </main>
    </div>
  )
}
