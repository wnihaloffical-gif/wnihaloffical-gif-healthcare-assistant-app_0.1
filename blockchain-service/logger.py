...
class Logger:
    ...
    def info(self, message: str, data: Optional[Dict[str, Any]] = None, module: str = "BLOCKCHAIN"):
        log_str = self._format_log("info", module, "INFO", message, data)
        print(log_str)
    
    def error(self, message: str, data: Optional[Dict[str, Any]] = None, module: str = "BLOCKCHAIN", 
             error: Optional[str] = None):
        log_str = self._format_log("error", module, "ERROR", message, data, error)
        print(log_str)
    
    def warn(self, message: str, data: Optional[Dict[str, Any]] = None, module: str = "BLOCKCHAIN"):
        log_str = self._format_log("warn", module, "WARN", message, data)
        print(log_str)
    
    def debug(self, message: str, data: Optional[Dict[str, Any]] = None, module: str = "BLOCKCHAIN"):
        if self.debug_mode:
